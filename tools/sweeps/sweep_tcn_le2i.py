...
def main() -> None:
    ...
    ap.add_argument("--exp", default="tcn_le2i_sweep", help="Name for this sweep run (output subfolder).")
    ...
    run = RunSpec(
        ...
        base_out_dir="outputs/le2i_tcn_W48S12",
    )
