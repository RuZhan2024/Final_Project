...
# -*- coding: utf-8 -*-
"""
Auto-sweep for TCN on CAUCAFALL (native FPS from Makefile)

- Loops over explicit parameter value lists (PARAM_GRID + STRATEGIES)
- Runs: `make train-tcn-caucafall OUT_TAG=... VAR=...`
- Reads: <save_dir>/history.jsonl
- Scores: best monitor_score across epochs (default: monitor_score)
- Writes: outputs/sweeps/tcn/caucafall/<exp>/* including best_command.sh
"""
...
def main() -> None:
    ...
    ap.add_argument("--exp", default="tcn_caucafall_sweep", help="Name for this sweep run (output subfolder).")
    ...
    run = RunSpec(
        ...
        base_out_dir="outputs/caucafall_tcn_W48S12",
    )
